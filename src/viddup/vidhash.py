...
#
# this is just a copy of imageio's ffmpeg plugin with additional crop
# filter for ffmpeg
#
...
import imageio.core.format as imageio_format

string_types = (str,)

if hasattr(imageio_format, "CannotReadFrameError"):
    CannotReadFrameError = imageio_format.CannotReadFrameError
else:
    class CannotReadFrameError(RuntimeError):
        pass

    imageio_format.CannotReadFrameError = CannotReadFrameError
...
class VidHashFormat(Format):
    ...
    class Reader(Format.Reader):
        ...
        def _load_infos(self):
            ...
            # the will never match with this setup
            # # Check the two sizes
